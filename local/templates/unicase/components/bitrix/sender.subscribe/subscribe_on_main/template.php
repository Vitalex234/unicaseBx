...
<!--		</div>-->
        <div class="bx-input-group form-group">
            <label class="sr-only" for="exampleInputEmail1">Email address</label>
            <input type="email" class="bx-form-control form-control" id="exampleInputEmail1" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
        </div>
...
<!--            <button class="btn btn-primary">Subscribe</button>-->
			<button class="btn btn-primary" id="bx_subscribe_btn_<?=$buttonId?>"><?=GetMessage("subscr_form_button")?></button>
