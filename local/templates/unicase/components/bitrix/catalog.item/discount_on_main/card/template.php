...
<div class="col col-xs-5">
    <div class="product-image">
        <div class="image">
            <a href="<?=$item['DETAIL_PAGE_URL']?>" data-lightbox="image-1" title="<?=$imgTitle?> data-title="<?=$imgTitle?>">
                <img class="special-deals-img" src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="">
...
<!--        <div class="rating rateit-small rateit">
            <button id="rateit-reset-11" data-role="none" class="rateit-reset" aria-label="reset rating"
                    aria-controls="rateit-range-11" style="display: none;"></button>
            <div id="rateit-range-11" class="rateit-range" tabindex="0" role="slider" aria-label="rating"
                 aria-owns="rateit-reset-11" aria-valuemin="0" aria-valuemax="5" aria-valuenow="4"
        ...
        <div class="product-price">
				<span class="price"><? echo $price['PRINT_RATIO_PRICE']?></span>

        </div><!-- /.product-price -->
<!--        <div class="action"><a href="#" class="lnk btn btn-primary">Add To Cart</a></div>-->

        <div class="action" id="<?=$itemIds['BASKET_ACTIONS']?>">
            <a class="lnk btn btn-primary <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
